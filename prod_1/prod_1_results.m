...
input = readtable('prod_1_input.xlsx');
input2 = readtable('Chen_data', 'Sheet', 'Final data');
input3 = readtable('prod_1_input_2.xlsx');
...
legend('Model: baseline', 'Model: TFP growth slowdown', 'Data', 'Projections', 'Location', 'southeast', 'FontName', 'SansSerif');
source_text_1 = 'Note: The dotted line shows the 2020-2040 projections for the relative TFP level of China, based on Peschel and Liu (2022).';
...
writetable(gdp_chn_table, 'prod_1_gdp_results.xlsx', 'Sheet', 'China');