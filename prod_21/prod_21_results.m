...
input = readtable('prod_21_input.xlsx');
input2 = readtable('Chen_data', 'Sheet', 'Final data');
input3 = readtable('prod_21_input_2.xlsx');
...
source_text_1 = 'Note: The dotted line shows the 2020-2040 projections for the relative TFP level of China, based on Peschel and Liu (2022) and adjusted for FDI outflows in 2021-23.';
...
writetable(gdp_chn_table, 'prod_21_gdp_results.xlsx', 'Sheet', 'China');